                    ...
                    <div class="main__change-pwd-inputs">
                        <InputField
                            ...
                            @blur="
                                handleValidInput(
                                    v$.curPassword,
                                    validation.validCurrentPassword
                                )
                            "
                            v-model="curPassword"
                            class="main__change-pwd-input current-password"
                            input_type="password"
                            isPwd
                            :class="{
                                'input--error': !validation.validCurrentPassword,
                            }"
                            placeholder="Current Password"
                        />
                        <p v-if="errors.curPasswordRequired" class="error-msg">
                            The current password is required
                        </p>
                        <p v-if="errors.curPasswordMinLength" class="error-msg">
...
export default {
    ...
    computed: {
        validation: function() {
            return {
                validCurrentPassword: !this.v$.curPassword.$error,
        ...
        errors: function() {
            return {
                curPasswordRequired:
                    this.v$.curPassword.required.$invalid &&
                    this.v$.curPassword.$dirty,
                curPasswordMinLength:
                    this.v$.curPassword.minLength.$invalid &&
                    this.v$.curPassword.$dirty,
                newPasswordRequired:
    ...
    methods: {
        ...
        handleInputPwd: function(value) {
            if (event.target.placeholder == "Current Password")
                this.curPassword = value;
            else if (event.target.placeholder == "New Password")
